import svgPaths from "./svg-j9jg10q3tg";
  ...
  return (
    <div className="h-[18.519px] relative shrink-0 w-[20.934px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 19">
        <g clipPath="url(#clip0_483_452)" id="Frame">
...
export default function A3() {
  return (
    <div className="bg-[#214bac] relative rounded-[74.115px] size-full" data-name="a3">
      <div className="flex flex-col items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[6.542px] items-center justify-center overflow-clip pb-[6.542px] pt-[9px] px-[6.542px] relative size-full">
          <Frame />
        </div>
      </div>
    </div>
