...
export function QuickPrintSettingsNew({
  ...
  const handleXOffsetChange = (value: string) => {
    setXOffset(value);
    onOffsetChange?.(value, yOffset);
  };

  const handleYOffsetChange = (value: string) => {
    setYOffset(value);
    onOffsetChange?.(xOffset, value);
  };
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <LandscapeIcon isActive={orientation === 'landscape'} isInverse={inverse} />
                    </div>
                  </button>
                  <div
                    style={{
                ...
                >
                  ...
                  >
                    ...
                    >
                      <PortraitIcon isActive={orientation === 'portrait'} isInverse={inverse} />
                    </div>
                  </button>
                  <div
                    style={{
            ...
            >
              ...
              <div className="box-border content-stretch flex flex-row gap-3 items-start justify-start p-0 relative shrink-0 w-full">
                <div className="basis-0 box-border content-stretch flex flex-row gap-1.5 grow items-center justify-start min-h-px min-w-px p-0 relative shrink-0">
                  <span
                    className={`text-xs ${centerOnPaper ? 'text-[#898b8c]' : 'text-[#d5d7e1]'}`}
                  >
                    X:
                  </span>
