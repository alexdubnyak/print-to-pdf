...
function Frame246() {
  return (
    <div className="h-[251.296px] relative shrink-0 w-[323.5px]">
      ...
      <div className="absolute flex h-[15.531px] items-center justify-center left-[0.46px] top-[-16.02px] w-[0px]">
        <div className="flex-none rotate-[270deg]">
      ...
      <div className="absolute flex h-[15.531px] items-center justify-center left-[323.95px] top-[-16.02px] w-[0px]">
        <div className="flex-none rotate-[270deg]">
          <div className="h-0 relative w-[15.535px]">
            <div className="absolute bottom-0 left-0 right-0 top-[-0.91px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 1">
      ...
      <div className="absolute flex h-[95.938px] items-center justify-center left-[330.8px] top-[1.83px] w-[0px]">
        <div className="flex-none rotate-[90deg]">
      ...
      <div className="absolute flex h-[95.938px] items-center justify-center left-[330.8px] top-[152.6px] w-[0px]">
        <div className="flex-none rotate-[90deg]">
          <div className="h-0 relative w-[95.95px]">
...
function Frame473() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-1.5 py-2.5 relative shrink-0">
      <div
        aria-hidden="true"
        className="absolute border-[#cfcfcf] border-[0px_0px_2px] border-solid inset-0 pointer-events-none"
      />
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row h-7 items-center justify-between p-[10px] relative w-full">
          <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
            <p className="block leading-[normal] whitespace-pre">Landscape</p>
          </div>
...
function Frame792() {
  return (
    <div className="box-border content-stretch flex flex-row gap-1.5 h-7 items-center justify-start p-0 relative shrink-0">
      <Component3 />
      <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">Fit to paper size</p>
      </div>
    </div>
  );
}
...
function Frame793() {
  return (
    <div className="box-border content-stretch flex flex-row gap-1.5 h-7 items-center justify-start p-0 relative shrink-0">
      <Component4 />
      <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">Scale lineweights</p>
      </div>
    </div>
  );
}
...
function Frame827() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-row grow items-start justify-between min-h-px min-w-px p-0 relative shrink-0 w-full">
      <Frame792 />
      <Frame793 />
    </div>
  );
...
function Frame819() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-2.5 grow h-[148px] items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
      <Frame817 />
      <Frame818 />
      <Frame827 />
    </div>
  ...
  return (
    <div className="bg-[#141518] h-7 relative shrink-0 w-full" data-name="dropdown">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row h-7 items-center justify-between p-[10px] relative w-full">
          <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
            <p className="block leading-[normal] whitespace-pre">1:1</p>
          </div>
          <div className="h-[6.145px] relative shrink-0 w-[10.875px]" data-name="Union">
            <svg
              className="block size-full"
...
function Dropdown3() {
  return (
    <div
      className="bg-[#141518] box-border content-stretch flex flex-row gap-3 h-7 items-center justify-start p-[10px] relative shrink-0"
      data-name="dropdown"
    >
      <div
        aria-hidden="true"
  ...
  return (
    <div className="basis-0 bg-[#141518] grow h-7 min-h-px min-w-px relative shrink-0" data-name="dropdown">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row h-7 items-center justify-between p-[10px] relative w-full">
          <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
            <p className="block leading-[normal] whitespace-pre">Milimetres</p>
          </div>
          <div className="h-[6.145px] relative shrink-0 w-[10.875px]" data-name="Union">
            <svg
              className="block size-full"
...
function Frame240() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-start px-5 py-0 relative w-full">
          <Frame819 />
  ...
  return (
    <div className="bg-[#141518] h-7 relative shrink-0 w-full" data-name="dropdown">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row h-7 items-center justify-between p-[10px] relative w-full">
          <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
            <p className="block leading-[normal] whitespace-pre">All geometry</p>
          </div>
          <div className="h-[6.145px] relative shrink-0 w-[10.875px]" data-name="Union">
            <svg
              className="block size-full"
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row font-['Open_Sans:Regular',_sans-serif] gap-1.5 h-7 items-center justify-start leading-[0] not-italic p-[10px] relative text-[12px] text-left text-nowrap w-full">
          <div className="relative shrink-0 text-[#d5d7e1]">
            <p className="block leading-[normal] text-nowrap whitespace-pre">1</p>
          </div>
          <div className="relative shrink-0 text-[#898b8c]">
            <p className="block leading-[normal] text-nowrap whitespace-pre">mm</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#141518] h-7 relative shrink-0 w-full" data-name="dropdown">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row h-7 items-center justify-between p-[10px] relative w-full">
          <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
            <p className="block leading-[normal] whitespace-pre">Print style.ctb</p>
          </div>
          <div className="h-[6.145px] relative shrink-0 w-[10.875px]" data-name="Union">
            <svg
              className="block size-full"
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1 items-start justify-start p-0 relative shrink-0 w-full">
      ...
      <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[10px] text-left w-full">
        <p className="block leading-[normal] whitespace-pre-wrap">{`You can upload new print style in the Resources   section`}</p>
      </div>
    </div>
  );
}
...
function Frame794() {
  return (
    <div className="box-border content-stretch flex flex-row gap-1.5 h-7 items-center justify-start p-0 relative shrink-0">
      <Component5 />
      <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#d5d7e1] text-[12px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">Print on center of paper</p>
      </div>
    </div>
  );
}
...
function Frame239() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-2.5 grow items-start justify-start min-h-px min-w-px overflow-clip p-0 relative shrink-0 w-full z-[2]">
      <Frame828 />
      <Frame238 />
    </div>
  );
...
function Frame217() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 h-full isolate items-start justify-start pb-0 pt-5 px-0 relative shrink-0 w-[571px]">
      <Frame816 />
      <Frame239 />
      <Frame249 />
    </div>
...
export default function PrintToPdf() {
  return (
    <div
      className="bg-[#333538] box-border content-stretch flex flex-col items-start justify-between p-0 relative shadow-[0px_4px_64px_0px_rgba(0,0,0,0.25)] size-full"
