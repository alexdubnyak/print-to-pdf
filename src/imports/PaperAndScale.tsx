import svgPaths from "./svg-ihx3787jd6";

export default function PaperAndScale() {
  return (
    <div
      className="bg-[#1e2023] relative size-full"
      data-name="paper and scale"
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row items-center justify-between px-5 py-1.5 relative size-full">
