...
const TECHNICAL_DRAWING_SHEET_1 = "figma:asset/7570a0196b27f18f336a34f1c7ff7a1826dd64a5.png"; // 707x500mm Horizontal
const TECHNICAL_DRAWING_SHEET_2 = "figma:asset/0cc96cd8916e1803db15b3d52193be720f65c57c.png"; // 841x594mm A1 Vertical

// Background Images  
const BACKGROUND_IMAGE_MAIN = "figma:asset/be261973d7e3f1732c0223807a6905b27036bd7e.png"; // Main dialog background
...
function CloseButton({ onClick }: { onClick: () => void }) {
  return (
    <div className="relative shrink-0 size-[37px] cursor-pointer hover:opacity-80 transition-opacity" data-name="actions" onClick={onClick}>
      <svg
...
function SettingsSection() {
  return (
    <div className="box-border content-start flex flex-col gap-2 items-start justify-start p-0 relative shrink-0 w-[323.5px]">
      <div className="font-['Open_Sans:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[12px] text-left text-nowrap" style={{ color: 'var(--color-text-muted)' }}>
...
function PreviewArea({ selectedCount, currentSheet, onSheetChange, selectedSheets }: { 
...
function LeftPreviewPanel({ selectedCount, currentSheet, onSheetChange, selectedSheets }: { 
  selectedCount: number; 
  currentSheet: number; 
  onSheetChange: (sheet: number) => void;
  selectedSheets: number[];
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-2.5 h-full items-center justify-start p-[20px] relative shrink-0 w-[400px]" style={{ backgroundColor: 'var(--color-dialog-bg-dark)' }}>
      <PreviewArea selectedCount={selectedCount} currentSheet={currentSheet} onSheetChange={onSheetChange} selectedSheets={selectedSheets} />
    </div>
  );
}
...
function SearchSection({ searchValue, onSearchChange }: { searchValue: string; onSearchChange: (value: string) => void }) {
  return (
...
function SearchSectionWrapper({ searchValue, onSearchChange }: { searchValue: string; onSearchChange: (value: string) => void }) {
  return (
...
// Checkbox Components
function SelectAllCheckbox({ selectAllChecked, onSelectAllClick }: { selectAllChecked: boolean; onSelectAllClick: () => void }) {
  return (
...
function Sheet1Checkbox({ sheet1Checked, onSheet1Click }: { sheet1Checked: boolean; onSheet1Click: () => void }) {
  return (
...
function Sheet1CheckboxWrapper({ sheet1Checked, onSheet1Click }: { sheet1Checked: boolean; onSheet1Click: () => void }) {
  return (
...
function Sheet1LayoutRow({ 
  ...
  return (
    <div className="sheet-layout-row">
      <Sheet1CheckboxWrapper sheet1Checked={sheet1Checked} onSheet1Click={onSheet1Click} />
...
function Sheet2Checkbox({ sheet2Checked, onSheet2Click }: { sheet2Checked: boolean; onSheet2Click: () => void }) {
  return (
    <div className="checkbox-row">
      <Checkbox 
...
function Sheet2CheckboxWrapper({ sheet2Checked, onSheet2Click }: { sheet2Checked: boolean; onSheet2Click: () => void }) {
  return (
    <div className="basis-grow-container">
      <div className="flex-center-container">
        <div className="padded-content">
...
function Sheet2LayoutRow({ 
  ...
  return (
    <div className="sheet-layout-row-2">
      <Sheet2CheckboxWrapper sheet2Checked={sheet2Checked} onSheet2Click={onSheet2Click} />
      <div className="select-container">
    ...
    <div className="relative shrink-0 w-full">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col-reverse gap-2.5 items-start justify-start px-5 py-0 relative w-full">
          <SelectAllCheckbox selectAllChecked={selectAllChecked} onSelectAllClick={onSelectAllClick} />
          <Sheet1LayoutRow 
  ...
  return (
    <div className="box-border content-stretch flex flex-col-reverse gap-5 h-full items-start justify-start pb-0 pt-5 px-0 relative shrink-0 w-[571px]">
      <MainConfigArea 
        ...
        appliedLayoutName={appliedLayoutName}
      />
      <ButtonToolbarBottom onPageLayoutClick={onPageLayoutClick} onPrintClick={onPrintClick} isPrintDisabled={isPrintDisabled} />
    </div>
  );
}
...
function DialogMainContent({ 
  ...
  return (
    <div className="basis-0 box-border content-stretch flex flex-row grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0 w-full">
      <LeftPreviewPanel selectedCount={selectedCount} currentSheet={currentSheet} onSheetChange={onSheetChange} selectedSheets={selectedSheets} />
      {isLayoutEditorOpen ? (
        <LayoutEditor 
  ...
  if (isPageLayoutManagerOpen) {
    return (
      <div className="relative size-full" data-name="Page Layout Manager">
        ...
        />
        <div 
          className="absolute top-[226px] translate-x-[-50%] print-dialog-position h-[362px] w-[770px]"
        >
          <PageLayoutManager 
  ...
  return (
    <div className="relative size-full" data-name="Print current sheet">
      <div
        ...
        style={{ '--bg-image': `url('${imgMainBackground}')` } as React.CSSProperties}
      />
      <div className="absolute h-[145.5px] left-[499px] top-[368.5px] w-[486.5px]" style={{ backgroundColor: 'var(--color-dialog-bg-darker)' }} />
      <BottomActionToolbar 
