...
export function CollapsibleSection({ 
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="bg-[#1e2023] relative shrink-0 w-full cursor-pointer" onClick={handleToggle}>
        <div className="flex flex-row items-center relative size-full">
          <div className="box-border content-stretch flex flex-row items-center justify-between px-5 py-1.5 relative w-full">
            ...
            <div className="flex items-center justify-center relative shrink-0">
              <div 
                className={`flex-none transition-transform duration-200 ${isOpen ? 'rotate-[180deg] scale-y-[-100%]' : ''}`}
              >
                <div
